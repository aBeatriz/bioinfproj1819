...
'''First: import_data
Second: run
Later: get_recon, get_genes_with_index, save_recon, save_data
'''
...
class Study_Metabolism():
    ...
    def import_converter(self):
        file = open('custom.txt', 'r') #doc from https://www.genenames.org/download/custom/
    ...
    def run(self):
        ...
        self.conversion_genes_ids()
        self.save_data()
        
           
if __name__ == "__main__":
    Metabolic_data = Study_Metabolism()
#    Metabolic_data.import_recon('Recon3D_301.mat')
#    Metabolic_data.save_recon()
    Metabolic_data.import_recon()  
    Metabolic_data.run()    
    print(len(Metabolic_data.get_genes_with_index()))
